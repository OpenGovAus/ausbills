"""
Mixin Classes for Attr-support, and AttrDict.

Copypasted from AttrDict because there are warnings about deprecating various imports from collections.
AttrDict is licensed under MIT. See: https://pypi.org/project/attrdict/
"""
...
__all__ = ['Attr', 'MutableAttr', 'AttrDict', 'merge']
